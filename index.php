        ...
        <div class="row">
            <div class="col-lg-6 order-2 order-lg-1">
                ...
                <div class="download-buttons d-flex flex-row justify-content-start">
                    ...
                    switch ($buttonLang) {
                        case 'nl':
                            echo "<div class='app-icons'><a href=#><img class='img-fluid' src='https://play.google.com/intl/en_us/badges/static/images/badges/nl_badge_web_generic.png' alt='Ontdek het op Google Play' width='180px' height='60px' /></a></div>";
