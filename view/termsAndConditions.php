...
// termsAndConditions class that contains the terms and conditions page

class termsAndConditions extends View
{
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p>Welcome to Playm8!</p>
                        <p>These terms and conditions outline the rules and regulations for the use of Playm8's Website,
                            located at https://www.playm8.eu.</p>
                        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to
                            use Playm8 if you do not agree to take all of the terms and conditions stated on this page.
                        </p>
                        ...
                        <p>We employ the use of cookies. By accessing Playm8, you agreed to use cookies in agreement
                            with the Playm8's Privacy Policy. </p>
                        ...
                        <p>Unless otherwise stated, Playm8 and/or its licensors own the intellectual property rights for
                            all material on Playm8. All intellectual property rights are reserved. You may access this
                            from Playm8 for your own personal use subjected to restrictions set in these terms and
                            conditions.</p>
                        <p>You must not:</p>
                        <ul>
                            <li>Republish material from Playm8</li>
                            <li>Sell, rent or sub-license material from Playm8</li>
                            <li>Reproduce, duplicate or copy material from Playm8</li>
                            <li>Redistribute content from Playm8</li>
                        </ul>
                        ...
                        <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                            information in certain areas of the website. Playm8 does not filter, edit, publish or review
                            Comments prior to their presence on the website. Comments do not reflect the views and
                            opinions of Playm8,its agents and/or affiliates. Comments reflect the views and opinions of
                            the person who post their views and opinions. To the extent permitted by applicable laws,
                            Playm8 shall not be liable for the Comments or for any liability, damages or expenses caused
                            and/or suffered as a result of any use of and/or posting of and/or appearance of the
                            Comments on this website.</p>
                        <p>Playm8 reserves the right to monitor all Comments and to remove any Comments which can be
                        ...
                        <p>You hereby grant Playm8 a non-exclusive license to use, reproduce, edit and authorize others
                        ...
                        <p>We will approve link requests from these organizations if we decide that: (a) the link would
                            ...
                            visibility of the hyperlink compensates the absence of Playm8; and (d) the link is in the
                        ...
                        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking
                            to our website, you must inform us by sending an e-mail to Playm8. Please include your name,
                        ...
                        <p>No use of Playm8's logo or other artwork will be allowed for linking absent a trademark
                            license agreement.</p>
                        ...
                        <hr />
                        <p>Generated using <a href="https://www.termsandconditionsgenerator.com">Terms and Conditions
                                Generator</a></p>
                    </div>
                </div>
            </div>
