...
<section>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1>Privacy Policy of Playm8</h1>
                <p>Playm8 operates the https://www.playm8.eu website, which provides the SERVICE.</p>
                <p>This page is used to inform website visitors regarding our policies with the collection, use,
                    and disclosure of Personal Information if anyone decided to use our Service, the Playm8
                    website.</p>
