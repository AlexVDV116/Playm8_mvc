...
if (isset($_POST["submit"])) {
    ...
    $newPermissionName = htmlspecialchars($_POST["permissionName"], ENT_QUOTES, "UTF-8");
    $newPermissionDescription = htmlspecialchars($_POST["permissionDescription"], ENT_QUOTES, "UTF-8");
    ...
    // Grab the permissionID from the hidden input
    // the roleController uses this to get the permission from the DB
