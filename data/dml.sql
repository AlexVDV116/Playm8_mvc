...
INSERT INTO `accounts` (`accountID`, `username`, `email`, `password`, `isBetaUser`, `userProfileID`, `isActive`, `activationCode`, `activationExpiry`, `activatedAt`) VALUES
  ('AID644e5491179c5', 'JohanVink91', 'johan91@hotmail.com', '$2y$10$PGp.e8doGD/i3AU1g8GnqeL6TcXwUbEtJ3Bq9QOABItMkj6KtKQEi', 0, 'UID644e5491179c5', 1, "$2y$10$6CZkHftRMvZONlBSN1XGW.wt7mBRDbyRDBkoqJYMqt/T2ZG6RFhMq", "2023-04-24 15:41:16", "2023-04-23 11:16:21"),
  ('AID644e5491179c8', 'Jeanette_Dijkstra', 'j_dijkstra@gmail.com', '$2y$10$8GSfjqTJN6kMDlT8ZVbJsex7rWUu0eFP2SGYVhwbBH258w5Y4gTaW', 1, 'UID644e5491179c8', 1, "$2y$10$IhD4b2b0BNXn.Rwv5AU.ZO1oSCj0ZRdNtlJVMP8Iy0Opxyyyl5mwK", "2023-04-24 15:41:16", "2023-04-23 11:16:21"),
  ...
  ('AID644e5491179ca', 'EviHoogland', 'evi_99@hotmail.com', '$2y$10$wSRdfnFuxqszyn8aGrB4AunVblTQ/LdWU6yj0YbFkYTb2fQlJil/.', 0, 'UID644e5491179ca', 1, "$2y$10$8byqr6MKfi1Lxa6dvVqrNO0TCFKhUk2AboeeEx.gT2CHUhbJGCEoW", "2023-04-24 15:41:16", "2023-04-23 11:16:21"),
...
INSERT INTO `userProfiles`(`userProfileID`, `firstName`, `lastName`, `city`, `country`, `phoneNumber`, `dateOfBirth`, `age`,`aboutMeTitle`,`aboutMeText`,`userProfilePicture`) VALUES
 ('UID644e5491179c5','Johan','Vink','Amsterdam','The Netherlands','+31654738829','1991-02-19','31','Over mij:','Hallo, ik ben een jonge professional die onlangs naar een nieuwe stad is verhuisd en op zoek is naar een harige vriend om me gezelschap te houden tijdens mijn dagelijkse wandelingen.','profilePic_UID644e5491179c5_1686516917.png'),
 ('UID644e5491179c8','Jeanette','Dijkstra','Breda','The Netherlands','+31688372293','1945-03-11','30','Over mij:','Hey daar, ik ben een gepensioneerde senior die dol is op tijd doorbrengen met mijn hond en op zoek is naar andere hondenbezitters om mee te socialiseren.','profilePic_UID644e5491179c8_1686516880.png'),
 ...
 ('UID644e5491179ca','Evi','Hoogland','Amstelveen','The Netherlands','+31678937784','1999-02-10','42','Over mij:','Hoi, ik ben een student die zijn gezinshond mist en graag tijd wil doorbrengen met een vriendelijke hond in mijn vrije tijd.','profilePic_UID644e5491179ca_1686516973.png'),
